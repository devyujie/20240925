  ...
  return (
    <>
      <div className="flex justify-between items-center p-[10px]">
        <div>
          <Link href="/" className="flex items-center justify-between p-[10px]">
            <svg viewBox="0 0 64 36" xmlns="http://www.w3.org/2000/svg" className="w-auto h-[18px]">
              <path
                fill="black"
            ...
            <span className="text-[20px] font-bold font-serif">PDF.ai</span>
          </Link>
        </div>
        <div>
          <ul className="flex gap-4 items-center justify-between">
            <li>
              <Link className="hover:underline font-medium text-sm p-2" href="/">
                Pricing
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link className="hover:underline font-medium text-sm p-2 flex items-center gap-1 justify-between" href="/">
                <span>Get Started</span>
                <ArrowRight className="w-auto h-3" />
              </Link>
            </li>
          </ul>
        </div>
